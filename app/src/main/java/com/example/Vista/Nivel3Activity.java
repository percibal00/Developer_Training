...
public class Nivel3Activity extends AppCompatActivity {
    ...
    private void finishGame() {
        ...
        if (aprobado) {
            ...
            rgOptions.setEnabled(false);
            Toast.makeText(this, "¡Nivel 3 superado! Haz clic en el botón para avanzar.", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(this, "Nivel 3 fallido. Volviendo al menú...", Toast.LENGTH_LONG).show();
